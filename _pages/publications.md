...
- Luyang Fang\*, **Haoran Lu**\*, Yongkai Chen, Wenxuan Zhong, Ping Ma (2026). [Knowledge Cascade: Reverse Knowledge Distillation on Nonparametric Multivariate Functional Estimation](http://jmlr.org/papers/v27/23-0359.html), ***Journal of Machine Learning Research***. (\* joint first authors)
- **Haoran Lu**, Luyang Fang, Wenxuan Zhong, Ping Ma (2026). [NeuroMAS: Multi-Agent Systems as Neural Networks with Joint Reinforcement Learning](https://openreview.net/pdf?id=psCz7NClif), ***The First Conference on Statistics and Trustworthy AI for Cross (X)-Domain Acceleration （STAI-X） （Paper Award Honorable Mention）***.
...
- Liu, Yufang, Yanjun Yang, **Haoran Lu**, Jiaheng Cui, Jackelyn Murray, Ralph A. Tripp, Xianyan Chen, Wenxuan Zhong, Ping Ma, and Yiping Zhao (2026). [AI-driven spectral decomposition for Raman and SERS signals in complex backgrounds](https://www.spiedigitallibrary.org/conference-proceedings-of-spie/14086/0000/AI-driven-spectral-decomposition-for-Raman-and-SERS-signals-in/10.1117/12.3100437.short), ***Optical Sensing and Detection IX***, vol. 14086. SPIE.
...
- Ping Ma, Yongkai Chen, **Haoran Lu**, Wenxuan Zhong (2024). [Bisection Grover's Search Algorithm and Its Application in Analyzing CITE-seq Data](https://app.box.com/s/ok6j8dh33wwa5xo7kthkkultd08jlqln). ***Journal of the American Statistical Association***, 1–12.
